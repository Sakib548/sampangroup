    ...
    <section className="bg-[#f7f8f5] px-6 py-16 text-[#183b2b] sm:px-10 lg:px-20 lg:py-24">
      <div className="mx-auto max-w-[1200px]">
        <div className="mb-10 flex items-center justify-between gap-6 border-y border-[#183b2b]/15 py-6">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[#ef636b]">Sampan residential portfolio</p>
          <span className="shrink-0 rounded-full bg-[#dcecff] px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-[#245b91]">{status}</span>
        </div>
